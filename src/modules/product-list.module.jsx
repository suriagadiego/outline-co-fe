            ...
            {!loading ? data?.map((d, index) => (
                <div key={index} className='p-md border border-solid 
                    ...
                    <div className='margin-auto'>
                        <img src="https://raw.githubusercontent.com/suriagadiego/outline-co-fe/e2824490fa267fab2bfd37a75531807d5d149821/src/assets/images/shirt2.png" alt={`Product ${index + 1}`} width={250} height={250}/>
                    </div>                    
